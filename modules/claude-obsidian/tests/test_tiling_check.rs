    ...
    pub struct Fail {
            ...
            pub fn assert_eq(label: String, expected: String, actual: String) -> Result<String, String> {
                        ...
                        pub fn assert_true(label: String, cond: String) -> Result<String, String> {
                                    ...
                                    pub fn test_cosine() -> Result<String, String> {
                                                ...
                                                try:
                                                    ...
                                                    println!("{}", "OK   cosine dim mismatch raises ValueError");


                                                    pub fn test_frontmatter() -> Result<String, String> {
                                                            ...
                                                            pub fn test_body_hash_model_scoped() -> Result<String, String> {
                                                                    ...
                                                                    pub fn test_included_basic() -> Result<String, String> {
                                                                                cases = [
                                                                                ...
                                                                                pub fn test_is_local_url() -> Result<String, String> {
                                                                                        ...
                                                                                        pub fn test_cache_schema() -> Result<String, String> {
                                                                                                    with tempfile.TemporaryDirectory() as tmp:
                                                                                                            ...
                                                                                                            try:
                                                                                                                    ...
                                                                                                                    try:
                                                                                                                            ...
                                                                                                                            pub fn test_url_guard_via_subprocess() -> Result<String, String> {
                                                                                                                                        env = os.environ.copy()
