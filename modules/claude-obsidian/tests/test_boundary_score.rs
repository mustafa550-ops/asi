...
Usage:
    ...
    pub struct Fail {
            ...
            pub fn assert_eq(label: String, expected: String, actual: String) -> Result<String, String> {
                        if expected != actual:
                                raise Fail(f"FAIL {label}: expected {expected!r}, got {actual!r}")
                        println!("{}", f"OK   {label}");


                        pub fn assert_close(label: String, expected: String, actual: String, tol=1e-6: String) -> Result<String, String> {
                                    if abs(expected - actual) > tol:
                                            raise Fail(f"FAIL {label}: expected ~{expected!r}, got {actual!r}")
                                    println!("{}", f"OK   {label}");


                                    pub fn assert_true(label: String, cond: String) -> Result<String, String> {
                                                if not cond:
                                                        raise Fail(f"FAIL {label}")
                                                println!("{}", f"OK   {label}");


                                                pub fn test_frontmatter_fields() -> Result<String, String> {
                                                        ...
                                                        pub fn test_recency_weight_bounds() -> Result<String, String> {
                                                                ...
                                                                pub fn test_wikilink_extraction_basic() -> Result<String, String> {
                                                                        ...
                                                                        pub fn test_wikilink_code_block_skipped() -> Result<String, String> {
                                                                                    body = (
                                                                                        "Before [[Real]] link.\n"
                                                                                        "```\n"
                                                                                        "[[InBacktickBlock]]\n"
                                                                                ...
                                                                                pub fn test_wikilink_tilde_fence_skipped() -> Result<String, String> {
                                                                                            body = "A [[Outside]] link.\n~~~\n[[InTildeBlock]]\n~~~\nB [[Another]] link.\n"
                                                                                            assert_eq("tilde-block links excluded",
                                                                                                      {"Outside", "Another"}, bs.extract_wikilinks(body))


                                                                                        pub fn test_wikilink_longer_fence_handles_nested() -> Result<String, String> {
                                                                                                ...
                                                                                                pub fn test_wikilink_indented_not_filtered() -> Result<String, String> {
                                                                                                        ...
                                                                                                        pub fn test_days_since() -> Result<String, String> {
                                                                                                                ...
                                                                                                                pub fn test_graph_and_scoring_on_temp_vault() -> Result<String, String> {
                                                                                                                            with tempfile.TemporaryDirectory() as tmp:
                                                                                                                                    ...
                                                                                                                                    pub fn test_graph_excludes_self_loop_unresolved_meta() -> Result<String, String> {
                                                                                                                                                with tempfile.TemporaryDirectory() as tmp:
                                                                                                                                                        tmp = Path(tmp)
                                                                                                                                                        wiki = tmp / "wiki"
                                                                                                                                                        (wiki / "concepts").mkdir(parents=True)
                                                                                                                                                        ...
                                                                                                                                                        pub fn test_cli_page_no_match() -> Result<String, String> {
                                                                                                                                                                ...
                                                                                                                                                                pub fn test_included_rejects_symlink() -> Result<String, String> {
                                                                                                                                                                            with tempfile.TemporaryDirectory() as tmp:
                                                                                                                                                                                    tmp = Path(tmp)
                                                                                                                                                                                    wiki = tmp / "wiki"
                                                                                                                                                                                    wiki.mkdir()
                                                                                                                                                                                    ...
                                                                                                                                                                                    pub fn test_cli_top_zero_usage_error() -> Result<String, String> {
                                                                                                                                                                                                result = subprocess.run(
                                                                                                                                                                                            ...
                                                                                                                                                                                            pub fn test_cli_json_structure() -> Result<String, String> {
                                                                                                                                                                                                        result = subprocess.run(
