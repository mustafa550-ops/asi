...
describe("Sidebar", () => {
  it("renders sidebar with aria label", () => {
    const { container } = render(
      <Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={false} onToggle={vi.fn()} />
    );
  ...
  it("shows logo when not collapsed", () => {
    render(<Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={false} onToggle={vi.fn()} />);
    expect(screen.getByText("ADLER")).toBeInTheDocument();
  });

  it("hides logo when collapsed", () => {
    render(<Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={true} onToggle={vi.fn()} />);
  ...
  it("highlights active tab", () => {
    render(<Sidebar items={items} activeTab="settings" onTabChange={vi.fn()} collapsed={false} onToggle={vi.fn()} />);
  ...
  it("fires onTabChange on click", () => {
    ...
    render(<Sidebar items={items} activeTab="chat" onTabChange={onTabChange} collapsed={false} onToggle={vi.fn()} />);
    const buttons = screen.getAllByRole("button");
  ...
  it("fires onToggle on toggle button click", () => {
    ...
    render(<Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={false} onToggle={onToggle} />);
  ...
  it("renders children in footer", () => {
    render(<Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={false} onToggle={vi.fn()}>footer</Sidebar>);
    expect(screen.getByText("footer")).toBeInTheDocument();
  });

  it("applies collapsed class", () => {
    const { container } = render(
      <Sidebar items={items} activeTab="chat" onTabChange={vi.fn()} collapsed={true} onToggle={vi.fn()} />
    );
