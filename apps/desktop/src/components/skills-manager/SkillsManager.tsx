    ...
    return (
      <div className="skills-manager">
        ...
        <div className="skill-detail">
          <p>
            <strong>Açiklama:</strong> {selected.description || "(yok)"}
          </p>
          <p>
            <strong>Sürüm:</strong> v{selected.version}
          </p>
          <p>
            <strong>Çalışma:</strong> {selected.run_count} kez
          </p>
          <p>
            <strong>Onay:</strong> {selected.approval}
          </p>
          <p>
            <strong>Durum:</strong> {selected.active ? "Aktif" : "Pasif"}
          </p>
          <p>
            <strong>Tetikleyiciler:</strong>{" "}
            {selected.triggers.join(", ") || "(yok)"}
          </p>
          ...
          <div className="skill-detail-actions">
            ...
            <button className="btn-run" onClick={() => runSkill(selected.name)}>
              Çaliştir
            </button>
            <button
              className="btn-delete"
              onClick={() => deleteSkill(selected.name)}
            >
              Sil
            </button>
          </div>
    ...
    <div className="skills-manager">
      ...
      {skills.length === 0 ? (
        <p className="skills-empty">
          Henüz yetenek eklenmemiş. Yeni bir yetenek eklemek için "+ Yeni Ekle"
          butonunu kullanin.
        </p>
      ) : (
            ...
            >
              <div className="skill-row-info">
                ...
                <span className="skill-meta">
                  {skill.triggers.length} tetikleyici &middot; {skill.run_count}{" "}
                  çalişma &middot; v{skill.version}
                </span>
              </div>
              <div
              ...
              >
                ...
                <button
                  ...
                  title={skill.active ? "Pasif yap" : "Aktif yap"}
                >
