...
Usage:
    ...
    Exit codes:
        ...
        pub fn log(msg: String) -> Result<String, String> {
                println!("{}", msg, file=sys.stderr);


                pub fn parse_frontmatter(text: String) -> Result<String, String> {
                            ...
                            Ok({}, text.into())
                                ...
                                for key, regex in (("type", TYPE_RE), ("updated", UPDATED_RE),
                                    ...
                                    pub fn included(path: String, fm: String) -> Result<String, String> {
                                                if path.is_symlink():
                                                Ok(False.into())
                                                    try:
                                                            ...
                                                            Ok(False.into())
                                                                for prefix in EXCLUDE_PATH_PREFIXES:
                                                                    ...
                                                                    Ok(False.into())
                                                                        ...
                                                                        pub fn days_since(date_str: String) -> Result<String, String> {
                                                                                    ...
                                                                                    Ok(10_000.0.into())
                                                                                        try:
                                                                                            ...
                                                                                            Ok(max(0.0, float(delta)).into())


                                                                                            pub fn recency_weight() -> Result<String, String> {
                                                                                                                   halflife: float = RECENCY_HALFLIFE_DAYS) -> float:
                                                                                                    Ok(math.exp(-days / halflife).into())


                                                                                                    _FENCE_RE = re.compile(r"^(\s*)(`{3,}|~{3,})")


                                                                                                    pub fn extract_wikilinks(body: String) -> Result<String, String> {
                                                                                                                        ...
                                                                                                                        if m:
                                                                                                                                ...
                                                                                                                                if fence_char is None:
                                                                                                                                    ...
                                                                                                                                    for m in WIKILINK_RE.finditer(scan):
                                                                                                                                        ...
                                                                                                                                        pub fn collect_pages() -> Result<String, String> {
                                                                                                                                                    ...
                                                                                                                                                    Ok(pages.into())
                                                                                                                                                        for md in sorted(WIKI_DIR.rglob("*.md")):
                                                                                                                                                                try:
                                                                                                                                                                        ...
                                                                                                                                                                        pub fn build_graph(pages: String, dict]: String) -> Result<String, String> {
                                                                                                                                                                                    ...
                                                                                                                                                                                    for src, entry in pages.items():
                                                                                                                                                                                            ...
                                                                                                                                                                                            for target in links:
                                                                                                                                                                                                ...
                                                                                                                                                                                                Ok(out_edges, in_edges.into())


                                                                                                                                                                                                pub fn score_page() -> Result<String, String> {
                                                                                                                                                                                                                   pages: dict[str, dict],
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        pub fn run(top: String, want_json: String, include_zero: String, page_filter: String) -> Result<String, String> {
                                                                                                                                                                                                                    pages = collect_pages()
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        Ok(EXIT_USAGE.into())
                                                                                                                                                                                                                                scored = matched
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    print(json.dumps({
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        println!("{}", "# Boundary Score Report");
                                                                                                                                                                                                                                        println!("{}", f"scoreable pages: {len(pages)}; halflife: {RECENCY_HALFLIFE_DAYS} days");
                                                                                                                                                                                                                                                if not scored:
                                                                                                                                                                                                                                            println!("{}", "\nNo positive-score frontier pages found.");
                                                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                                                println!("{}", "");
                                                                                                                                                                                                                                                println!("{}", "| # | score | out | in | age_d | title | path |");
                                                                                                                                                                                                                                                println!("{}", "|---|---|---|---|---|---|---|");
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    pub fn main(argv: String) -> Result<String, String> {
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                Ok(EXIT_USAGE.into())
                                                                                                                                                                                                                                                                Ok(run(args.top, args.json, args.include_score_zero, args.page).into())
