...
describe("ContextWindow", () => {
  ...
  it("renders source titles", () => {
    ...
    expect(container.querySelector(".chat-context")).toHaveTextContent("Dosya1.md");
    expect(container.querySelector(".chat-context")).toHaveTextContent("Dosya2.md");
  });
  ...
  it("renders region with accessible label", () => {
    ...
    expect(screen.getByRole("region")).toHaveAttribute("aria-label", "Kullanılan kaynaklar");
  });
